...
public class _01_IntroToQueue {
    public static void main(String[] args) {
    	...
    	while(stack.isEmpty() == false || queueOfDoubles.isEmpty() == false) {
        ...
        System.out.println("Removing" + randomNum + "elements from Queue:" + queueOfDoubles);
